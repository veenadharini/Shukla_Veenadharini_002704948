 ...
 * @author Veenadharini
 */
public class EncounterHistFrame extends javax.swing.JFrame {

    /**
     * Creates new form EncounterHistFrame
     */
    public EncounterHistFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Encounter History ");
        ...
        tblEncountHist.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Temperature", "Blood Pressure", "Pulse Rate", "Diagnosis"
            }
        ));
        jScrollPane1.setViewportView(tblEncountHist);

        bttnview.setText("View History");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(177, 177, 177)
                .addComponent(bttnview, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bttnviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttnviewActionPerformed
        ...
        try{
            ...
            while(rs.next()){
                Object o[] = {rs.getString("date"), rs.getString("temperature"),rs.getString("bloodpressure"),rs.getString("pulse"),rs.getString("diagnosis")};
                tbl.addRow(o);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EncounterHistFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EncounterHistFrame().setVisible(true);
            }
        });
    }
